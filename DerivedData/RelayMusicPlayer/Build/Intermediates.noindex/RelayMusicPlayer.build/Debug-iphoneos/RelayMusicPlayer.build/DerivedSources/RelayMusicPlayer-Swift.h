...
#import "/Users/theckraft/Documents/Programming/Xcode/RelayMusicPlayer/RelayMusicPlayer/RelayMusicPlayer-Bridging-Header.h"
...
SWIFT_MODULE_NAMESPACE_PUSH("RelayMusicPlayer")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC16RelayMusicPlayer11AppDelegate")
...
SWIFT_CLASS("_TtC16RelayMusicPlayer25MusicPlayerViewController")
...
- (IBAction)pauseButtonPressed:(id _Nonnull)sender;
- (IBAction)nextButtonPressed:(id _Nonnull)sender;
- (IBAction)previousButtonPressed:(id _Nonnull)sender;
- (void)viewDidLoad;
